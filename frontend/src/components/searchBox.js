...
$("button").on("click", function(e) {
  ...
  if (latRequest && lngRequest !== "") {
    ...
    $(".form").fadeOut(100, function() {
      weatherReport();
      $(".screen").append(
        '<button id="back">New Forecast</button><h3 class="city">' +
          city_name +
...
function insertGoogleScript() {
  ...
  google_api.src =
    ...
    api_key +
    "&callback=initGoogleAPI&libraries=places,geometry";
...
function initGoogleAPI() {
  ...
  autocomplete.addListener("places_changed", function() {
    ...
    latRequest = place.geometry.location.lat();
    lngRequest = place.geometry.location.lng();
